  ...
  <form id="article_class_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="vd_name" id="ac_name" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="vd_parent_id" id="ac_parent_id">
              ...
              <option <?php if($output['vd_parent_id'] == $v['vd_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['vd_id'];?>"><?php echo $v['vd_name'];?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
