      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="class_id" id="class_id" required>
              ...
              <option <?php if($output['class_id'] == $v['class_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['class_id'];?>"><?php echo $v['class_name'];?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="article_title_short" id="article_title_short" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea id="article_abstract" class="textarea" name="article_abstract" style="width: 700px;height: 85px;"></textarea></td>
          <td class="vatop tips"></td>
        </tr>
         <tr>
        ...
        <tr class="noborder">
          <td colspan="2" class="vatop rowform"><input id="article_author" class="text w100 valid" name="article_author" type="text" value="<?php echo $output['admin_info']['name']?>"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td colspan="2" class="vatop rowform">
          <input id="article_link" name="article_link" type="hidden" value="">
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="article_recommend1" class="cb-enable selected" ><span><?php echo $lang['nc_yes'];?></span></label>
            ...
            <input id="article_recommend1" name="article_recommend" checked="checked" value="1" type="radio">
            <input id="article_recommend0" name="article_recommend" value="0" type="radio"></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr>
          <td colspan="2"><ul id="thumbnails" class="thumblists">
              ...
              <li id="<?php echo $v['upload_id'];?>" class="picture" >
                ...
                <p><span><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');">插入 </a></span><span><a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');"><?php echo $lang['nc_del'];?></a></span></p>
              </li>
              <?php } ?>
              <?php } ?>
            </ul><div class="tdare">
